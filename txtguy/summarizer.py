...
from txtguy.app.summarize import SummarizerOrchestrator
from txtguy.domain.errors import ContentTooLongError
...
class Summarizer:
    ...
    For new code, use txtguy.app.summarize.SummarizerOrchestrator directly.
    """
